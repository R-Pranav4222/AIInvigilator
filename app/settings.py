...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='test')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='test')
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER


# Twilio Config
TWILIO_ACCOUNT_SID = env('TWILIO_ACCOUNT_SID', default='test')
TWILIO_AUTH_TOKEN = env('TWILIO_AUTH_TOKEN', default='test')
TWILIO_PHONE_NUMBER = env('TWILIO_PHONE_NUMBER', default='test')
